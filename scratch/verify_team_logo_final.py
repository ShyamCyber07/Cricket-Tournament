...
def main():
    ...
    # Tap Create button
    create_coords = get_node_center_by_text("Create") or (712, 1600)
    ...
    print("Force stopping app to verify persistence...")
    run_adb(["shell", "am", "force-stop", "com.cricup"])
    time.sleep(1.5)
    ...
    print("Team list nodes after restart:")
    dump_screen_nodes()
    capture_screen("5_team_logo_persistence.png")
    print("Team Logo final verification completed!")
