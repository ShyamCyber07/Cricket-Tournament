...
def main():
    ...
    # Tap 'Start Match Setup' (bounds [110,652][569,765] -> center (340, 708) or let's use text search if available, but bounds is fine)
    print("Tapping Start Match Setup at (340, 708)...")
    run_adb(["shell", "input", "tap", "340", "708"])
    time.sleep(4.0)
    
    print("Match Setup screen nodes:")
    dump_screen_nodes()
