...
def main():
    print("Before tap screen:")
    dump_screen_nodes()
    
    print("Tapping Return to Dashboard at (540, 1963)...")
    run_adb(["shell", "input", "tap", "540", "1963"])
    time.sleep(3.0)
    
    print("After tap screen:")
    dump_screen_nodes()
    capture_screen("after_dismiss_tap.png")
